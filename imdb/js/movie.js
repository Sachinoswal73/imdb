let movieArr = [
  ...
  for ( let i=0; i < movieArr.length ; i++ ) {
    ...
    <div class="card">
        <div class="movieCard">
                <img src="https://image.tmdb.org/t/p/w1280${ movieArr[i].poster_path }" alt="${ movieArr[i].title }">
                <figcaption class="fg1 text-white p-4 bg-dark">
                    <div class="row">
                        <div class="col-sm-8">
                        ...
                        <div class="col-sm-4 mt-1">
                            <p>
                            Rating : ${ movieArr[i].vote_average.toFixed(1)} 
                            <br>
                            <span style="font-size:8.5px">
                            ( from ${ movieArr[i].vote_count.toLocaleString('en-IN') } users ) 
                            </span>
                            </p>
                        </div>
                    </div>
                </figcaption>
                <div class="overview bg-light p-3">
                    <h4>Overview</h4>
                    <p class="small"> ${ movieArr[i].overview } </p>
                </div>
        </div>
    </div>
</div>
