const countries = [
  ...
  result = `<div class="row mt-4 crow">`;

  for( let c = 0; c <= countries.length; c++ ) {

    result += ` <div class="col-lg-3 mb-4 country">
                    <div class="card">
                            <div class="cflag">
                                <img src="${ countries[c].flag }">
                            </div>
                            <figcaption>
                                <div class="mb-4 cinfo ml-3 mr-3">
                                    <h3 class="text-center text-uppercase mt-2 mb-3 h3t">${ countries[c].name }</h3>
                                    <p class="mb-1"><b>Capital</b> : ${ countries[c].capital } </p>
                                    <p class="mb-1"><b>Languages</b> : ${ countries[c].languages.join(", ") } </p>
                                    <p><b>Population</b> : ${ countries[c].population } </p>  
                                </div>
                            </figcaption>
                    </div>
                </div>
    ...
    // console.log(`${ countries[c].name } | ${ countries[c].languages[0] } | ${ countries[c].population }`);
